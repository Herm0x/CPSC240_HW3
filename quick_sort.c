...
//  Date of last update: 2023-Mar-012
...
//
//Purpose
//  This module's purpose is to use the quick sort algorithm to organize and sort the array's elements from
//  least to greatest by making comparisons. 
//
//This file
//  File name: quick_sort.c
//  Language: C
//  Max page width: 132 columns  [132 column width may not be strictly adhered to.]
//  Compile this file: gcc -c -Wall -no-pie -m64 -std=c2x -o quick_sort.o quick_sort.c
